...
# 🚆 Виртуальный ассистент РЖД

### Локальный AI-помощник для работы с технической документацией

Прототип веб-приложения, которое помогает сотрудникам железнодорожной отрасли<br>
быстро находить информацию в регламентах, инструкциях и руководствах.
...
Задача проекта — создать единый интерфейс для взаимодействия с локальным
AI-ассистентом, который отвечает на вопросы по специализированной документации.
...
> Проект является хакатонным прототипом и не является официальным сервисом ОАО «РЖД».
...
**Денис — frontend / full-stack разработчик**

- GitHub: [@nezqt3](https://github.com/nezqt3)
